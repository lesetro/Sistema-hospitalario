  ...
  up: async (queryInterface, Sequelize) => {
    ...
    try {
      ...
      await queryInterface.createTable('Diagnosticos', {
        ...
        tipo_diagnostico_id: { type: Sequelize.INTEGER, allowNull: false, references: { model: 'TiposDiagnostico', key: 'id' } },
        descripcion: { type: Sequelize.TEXT, allowNull: false },
        created_at: { type: Sequelize.DATE, allowNull: false },
        updated_at: { type: Sequelize.DATE, allowNull: false }
      }, { transaction, indexes: [{ fields: ['evaluacion_medica_id'] }, { fields: ['tipo_diagnostico_id'] }] });
      ...
      await queryInterface.createTable('EstudiosSolicitados', {
        ...
        created_at: { type: Sequelize.DATE, allowNull: false },
        updated_at: { type: Sequelize.DATE, allowNull: false }
      }, { transaction, indexes: [{ fields: ['evaluacion_medica_id'] }, { fields: ['tipo_estudio_id'] }] });
      ...
      await queryInterface.createTable('TurnosEstudios', {
        ...
        created_at: { type: Sequelize.DATE, allowNull: false },
        updated_at: { type: Sequelize.DATE, allowNull: false }
      }, { transaction, indexes: [{ fields: ['estudio_solicitado_id'] }] });
      ...
      await queryInterface.createTable('ListasEsperas', {
        ...
        estudio_id: { type: Sequelize.INTEGER, allowNull: true, references: { model: 'EstudiosSolicitados', key: 'id' } },
        prioridad: { type: Sequelize.INTEGER, allowNull: false, defaultValue: 1 },
        created_at: { type: Sequelize.DATE, allowNull: false },
        updated_at: { type: Sequelize.DATE, allowNull: false }
      }, { transaction, indexes: [{ fields: ['paciente_id'] }, { fields: ['especialidad_id'] }, { fields: ['turno_id'] }, { fields: ['estudio_id'] }] });
      ...
      await queryInterface.createTable('ControlesEnfermeria', {
        ...
        frecuencia_cardiaca: { type: Sequelize.INTEGER, allowNull: true },
        created_at: { type: Sequelize.DATE, allowNull: false },
        updated_at: { type: Sequelize.DATE, allowNull: false }
